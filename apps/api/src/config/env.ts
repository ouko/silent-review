...
// Load environment variables from the monorepo root .env file only in
// non-production environments. In production, variables should be injected by
// the runtime to avoid accidentally overriding secrets with a copied .env file.
